...
require_once '../src/Repositorio/VendaRepositorio.php';
        ...
        <div class="container-direita">
            <?php if (!isset($_GET['modo']) || !isset($_GET['id']) || $_GET['modo'] != 'editar') : ?>
                <div class="container-direita-normal">
                    <?php gerarLink("salvar.php?" . http_build_query(['pecas' => $pecasSelecionadas]), "Registrar Venda", "padrao", $mainDir) ?>
            ...
            <?php elseif ($_GET['modo'] == 'editar') : ?>
                <form class="container-editar" action="verificar.php" method="GET">
                    ...
                    for ($i = 0; $i < count($pecasSelecionadas); $i++) {
                        ...
                        if ($i == $selecionado) {
                            gerarInputComValue("quantidade", "number", "Quantidade", "Quantidade vendida", $pecasSelecionadas[$selecionado]['quantidade'], $mainDir);
                            gerarInputDecimalComValue("preco", "0.01", "Preço", "Preço pelo qual foi vendido (total)", $pecasSelecionadas[$selecionado]['preco'], $mainDir);
                        }
                    }
                    ?>
