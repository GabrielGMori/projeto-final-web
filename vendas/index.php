...
$total = $repoVenda->contar();
$offset = ($paginaAtual - 1) * $limitePorPagina;
$totalPaginas = ceil($total / $limitePorPagina);

$vendas = $repoVenda->listarPaginado($limitePorPagina, $offset);

if (isset($_GET['id'])) {
    $_GET['id'] = (int) $_GET['id'];
    $selecionado = $repoVenda->buscarPorId($_GET['id']);
}
            ...
            foreach ($vendas as $venda) {
                ...
                echo '<div class="lista-item-expansivel">
                        ...
                        <div class="lista-item-expansivel-topo">
                            <h3>Venda ' . htmlspecialchars($venda->getDataFormatada()) . '</h3>
                            <a href="' . criarParamsGet("excluir", $venda->getId(), $limitePorPagina, $paginaAtual, null) . '" class="lista-item-excluir">
        ...
        <div class="container-direita">
            ...
            <?php elseif ($_GET['modo'] == 'excluir') : ?>
                <div class="container-excluir">
                    ...
                    <br>
                    <p><b><?php echo "Venda " . htmlspecialchars($selecionado->getDataFormatada()); ?></b></p>
                    <br>
                    <div class="acoes">
                        <?php
