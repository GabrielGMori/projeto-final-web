...
<head>
    ...
    <title>Nova Reposição (<?= $peca->getNome() ?>)</title>
</head>
    ...
    <main>
        ...
        <section class="container-form">
            <form action="../verificar.php" method="GET">
                ...
                <?php
                gerarInput("quantidade", "number", "Quantidade", "Quantidade comprada", $mainDir);
                gerarInputDecimal("preco", "0.01", "Preço", "Preço pelo qual foi comprado (total)", $mainDir);
                ?>
